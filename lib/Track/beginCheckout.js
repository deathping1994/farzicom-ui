...
const beginCheckout = (shopMetaData, { cart_amount, currency, items }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    fetch(`${(FC_TRACKING === null || FC_TRACKING === void 0 ? void 0 : FC_TRACKING.api_uri) || "https://t.farziengineer.co/collect"}/?evt_type=BeginCheckout`, {
        method: "POST",
        credentials: "include",
        headers: {

...
let previousURL = "";
let pageViewQueue = [];
const pageViewTrack = (shopMetaData, routerAsPath, tags) => __awaiter(void 0, void 0, void 0, function* () {
    pageViewQueue.push({
        shopMetaData,
        routerAsPath,
        tags,
    });
    const processPageViewQueue = (shopMetaData, routerAsPath, tags) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (sessionStorage.getItem("ip")) {
            ...
            try {
                const res = yield fetch("https://tr.farziengineer.co/ip");
        ...
        fetch((FC_TRACKING === null || FC_TRACKING === void 0 ? void 0 : FC_TRACKING.api_uri) || "https://t.farziengineer.co/collect", {
            ...
            if (nextItem && (pageViewQueue === null || pageViewQueue === void 0 ? void 0 : pageViewQueue.length) > 0) {
                processPageViewQueue(nextItem.shopMetaData, nextItem.routerAsPath, nextItem.tags);
            }
        });
    });

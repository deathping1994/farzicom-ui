...
exports.purchaseTrack = void 0;
const js_cookie_1 = __importDefault(require("js-cookie"));
const utils_1 = require("../utils");
const purchaseTrack = (shopMetaData, { transaction_id, order_amount, tax, shipping_charge, currency, items, tags, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    fetch(`${(FC_TRACKING === null || FC_TRACKING === void 0 ? void 0 : FC_TRACKING.api_uri) || "https://tr.farziengineer.co/collect"}/?evt_type=Purchase`, {
        method: "POST",
        credentials: "include",
        headers: {
...
exports.purchaseTrack = purchaseTrack;
